...
* The `button` option now accepts either a single button (ID string, element, or jQuery object) or an array of buttons. If an array is passed, each element in the array will work as an upload button
