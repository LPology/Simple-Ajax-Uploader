...
```javascript  
	var uploader = new ss.SimpleUpload({
        ...
        onSubmit: function(filename, extension) {
         ...
         // is encased in the "wrapper", which is designated to be removed with setProgressContainer() 
...
When a file is uploaded, a progress bar is dynamically created, the elements of which are assigned specific roles with using three functions:
