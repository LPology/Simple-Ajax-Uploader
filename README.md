...
The three functions below -- <code>setProgressBar()</code>, <code>setFileSizeBox()</code>, and <code>setProgressContainer</code>, were created specifically for supporting multiple, simultaneous progress bars. 
