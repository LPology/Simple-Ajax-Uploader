...
<strong>1. Single file uploading</strong> - Only one upload allowed at a time. Progress bar is an on-page element that is re-used with each upload.
...
#### Method 1: Single file uploading  ####
