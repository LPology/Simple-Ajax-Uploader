...
For the multiple file upload configuration, we use an additional function, `setProgressContainer(elem)`, to designate an element to be removed from the DOM after the upload is completed:
