...
<table>
    ...
    <tbody>        
        ...
        <tr>
            ...
            <td><code>filename</code> (String), <code>extension</code> (String)</td>
            <td>Function to be called before file is uploaded. The function gets passed two arguments: a string containing the filename; a string containing the file extension.<br />Returning <code>false</code> will prevent the upload from starting.<br /></td>
        </tr>
        <tr>
