...
<strong>Note:</strong> This PHP is included for convenience. It is <strong>not</strong> required to use PHP with Simple Ajax Uploader. The plugin is agnostic to server configuration, so use any language you prefer.
