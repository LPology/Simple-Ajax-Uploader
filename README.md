...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><i>none</i></td>
            <td>Remove the currently active file from the queue. Must be called prior to the start of upload (for example, in the <code>onSubmit()</code> or <code>onChange()</code> callbacks).</td>
        </tr>	        
	</tbody>
</table>
