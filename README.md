...
This project began life as a rewrite of Andrew Valum's original Ajax Upload plugin. Maintaining the same simplistic design and customizable architecture of Andrew's original plugin is a top priority.
