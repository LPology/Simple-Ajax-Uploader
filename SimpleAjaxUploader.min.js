...
var ss=ss||{};ss.obj2string=function(a,b){var c=[],f;if("object"!==typeof a)return"";for(f in a)if(a.hasOwnProperty(f)){var e=b?b+"["+f+"]":f,g=a[f];c.push("object"===typeof g?ss.obj2string(g,e):encodeURIComponent(e)+"="+encodeURIComponent(g))}return c.join("&")};ss.extendObj=function(a,b){var c;if("object"!==typeof a||"object"!==typeof b)return!1;for(c in b)b.hasOwnProperty(c)&&(a[c]=b[c])};ss.contains=function(a,b){for(var c=a.length;c--;)if(a[c]===b)return!0;return!1};
...
ss.getOffsetSum=function(a){for(var b=0,c=0;a;)b+=parseInt(a.offsetTop,10),c+=parseInt(a.offsetLeft,10),a=a.offsetParent;return{top:b,left:c}};ss.getOffsetRect=function(a){a=a.getBoundingClientRect();var b=document.body,c=document.documentElement,f=a.left+(window.pageXOffset||c.scrollLeft||b.scrollLeft)-(c.clientLeft||b.clientLeft||0);return{top:Math.round(a.top+(window.pageYOffset||c.scrollTop||b.scrollTop)-(c.clientTop||b.clientTop||0)),left:Math.round(f)}};
...
margin:0,padding:0,fontSize:"480px",fontFamily:"sans-serif",cursor:"pointer"});if("0"!==b.style.opacity){if("undefined"==typeof b.filters)throw Error("Opacity not supported by the browser");b.style.filter="alpha(opacity=0)"}ss.addEvent(c,"change",function(){var b,e,g;if(c&&""!==c.value){if(!a._settings.multiple||!a._XhrIsSupported){b=ss.getFilename(c.value);e=ss.getExt(b);if(!1===a._settings.onChange.call(a,b,e))return;a._queue.push(c)}else{g=c.files.length;b=null!==c.files[0].fileName&&void 0!==
c.files[0].fileName?c.files[0].fileName:c.files[0].name;b=ss.getFilename(b);e=ss.getExt(b);if(!1===a._settings.onChange.call(a,b,e))return;for(b=0;b<g;b++)a._queue.push(c.files[b])}a._clearInput();a._settings.autoSubmit&&a.submit()}});ss.addEvent(c,"mouseover",function(){ss.addClass(a._button,a._settings.hoverClass)});ss.addEvent(c,"mouseout",function(){var b=a._button,e=a._settings.focusClass;ss.removeClass(b,a._settings.hoverClass);ss.removeClass(b,e);c.parentNode&&(c.parentNode.style.visibility=
...
b.setAttribute("action",this._settings.url);b.setAttribute("target",a.name);return b},_createHiddenInput:function(a,b){var c=document.createElement("input");c.setAttribute("type","hidden");c.setAttribute("name",a);c.setAttribute("value",b);return c},_finish:function(a,b,c,f,e){this.log("server response: "+a);this._activeUploads--;"json"==this._settings.responseType.toLowerCase()&&(a=ss.parseJSON(a));!1===a?(this.log("bad server response"),this._settings.onError.call(this,b,"parseerror",a)):this._settings.onComplete.call(this,
b,a);e&&ss.remove(e);this._disabled&&this.enable();this._cycleQueue()},_cycleQueue:function(){this._progressContainer=this._progressBar=this._fileSizeBox=this._ext=this._filename=this._file=this._size=null;0<this._queue.length&&this.submit()},_uploadXhr:function(){var a=this,b=a._settings,c=a._filename,f=Math.round(a._size/1024),e=a._fileSizeBox,g=a._progressBar,h=a._progressContainer,d=ss.newXHR(),j={};!1===b.startXHR.call(a,c,f)?(a._disabled&&a.enable(),this._activeUploads--):(e&&(e.innerHTML=f+
"K"),b.onProgress.call(a,0),g&&(g.style.width="0%"),j[b.name]=c,ss.extendObj(j,b.data),j=b.url+"?"+ss.obj2string(j),ss.addEvent(d.upload,"progress",function(c){c.lengthComputable&&(c=Math.round(100*(c.loaded/c.total)),b.onProgress.call(a,c),g&&(g.style.width=c+"%"))}),ss.addEvent(d.upload,"error",function(){a.log("transfer error during upload");b.endXHR.call(a,c,f);b.onError.call(a,c,"transfer error","none")}),d.onreadystatechange=function(){4===this.readyState&&(200===this.status?(b.endXHR.call(a,
c,f),a._finish(this.responseText,c,g,e,h)):(a.log("Progress key error. Status: "+this.status+" Response: "+this.responseText),b.onError.call(a,c,"server error",this.responseText)))},d.open("POST",j,!0),d.setRequestHeader("X-Requested-With","XMLHttpRequest"),d.setRequestHeader("X-File-Name",encodeURIComponent(c)),"json"==b.responseType.toLowerCase()&&d.setRequestHeader("Accept","application/json, text/javascript, */*; q=0.01"),!0===b.multipart?(j=new FormData,j.append(b.name,a._file),a.log("commencing upload using multipart form"),
d.send(j)):(d.setRequestHeader("Content-Type","application/octet-stream"),a.log("commencing upload using binary stream"),d.send(a._file)),a.removeCurrent())},_handleIframeResponse:function(a,b,c,f,e){var g;a.parentNode&&(g=a.contentWindow?a.contentWindow.document:a.contentDocument&&a.contentDocument.document?a.contentDocument.document:a.contentDocument,g.body&&!1===g.body.innerHTML||(g=g.body.innerHTML,ss.remove(a),this._finish(g,b,c,f,e)))},_uploadIframe:function(){var a=this,b=a._settings,c=b.checkProgressInterval,
f=a._uploadProgressKey,e=a._progressBar,g=a._progressContainer,h=a._fileSizeBox,d=a._filename,j=a._createIframe(),k=a._createForm(j),l;a._doProgressUpdates&&(l=a._createHiddenInput(b.keyParamName,f),k.appendChild(l));if(!1===b.startNonXHR.call(a,d))a._disabled&&a.enable(),this._activeUploads--;else{l=b.data;b.onProgress.call(a,0);e&&(e.style.width="0%");for(var m in l)if(l.hasOwnProperty(m)){var n=a._createHiddenInput(m,l[m]);k.appendChild(n)}k.appendChild(a._file);ss.addEvent(j,"load",function(){ss.contains(a._activeProgressKeys,
f)&&ss.removeItem(a._activeProgressKeys,f);ss.removeEvent(j,"load",arguments.callee);b.endNonXHR.call(a,d);a._handleIframeResponse(j,d,e,h,g);f=null});a.log("commencing upload using iframe");k.submit();ss.remove(k);k=null;a._doProgressUpdates&&(a._activeProgressKeys.push(f),window.setTimeout(function(){a.log("requesting first progress update");a._getUploadProgress(f,e,h,1)},c),a._alterProgressKey());a.removeCurrent()}},_getUploadProgress:function(a,b,c,f){if(a){var e=this,g=e._settings,h=ss.newXHR(),
d=(new Date).getTime(),d=g.progressUrl+"?progresskey="+encodeURIComponent(a)+"&_="+d;h.onreadystatechange=function(){var d,h=g.checkProgressInterval;if(4===this.readyState)if(200===this.status){if((d=ss.parseJSON(this.responseText))&&!0===d.success){f++;g.onUpdateFileSize.call(e,d.size);g.onProgress.call(e,d.pct);b&&(b.style.width=d.pct+"%");c&&d.size&&(c.innerHTML=d.size+"K");if(100>d.pct&&ss.contains(e._activeProgressKeys,a)){if(0===d.pct&&0===d.size&&f>=e._maxUpdateFails){e.log("reached limit of failed progress requests");
return}window.setTimeout(function(){e._getUploadProgress(a,b,c,f);f=a=null},h)}h=null}}else e.log("Progress error. Status: "+this.status+" Response: "+this.responseText);d=null};h.open("GET",d,!0);h.setRequestHeader("X-Requested-With","XMLHttpRequest");h.setRequestHeader("Accept","application/json, text/javascript, */*; q=0.01");h.setRequestHeader("Cache-Control","no-cache");h.send();h=null}},_alterProgressKey:function(){this._uploadProgressKey+=ss.getUID()},_getUploadProgressKey:function(){var a=
...
"application/json, text/javascript, */*; q=0.01");b.setRequestHeader("Cache-Control","no-cache");b.send();b=null},_errorMsg:function(a){var b=this._settings.messages,c,f="";if("ext"==a){var e=this._settings.allowedExtensions,g=e.length,h,d;c=RegExp("{ext}","g");for(d=0;d<g;d++)h=e[d].toUpperCase(),d+2===g?h+=" or ":2<g&&d+2<g&&(h+=", "),f+=h;c=b.extError.replace(c,f);alert(c)}"size"==a&&(f=this._settings.maxSize+"K",c=RegExp("{size}","g"),c=b.sizeError.replace(c,f),alert(c))},_checkFile:function(){if(!this._file||
""===this._file.value)return this.log("no file to upload"),!1;if(0<this._settings.allowedExtensions.length&&!this._checkExtension(this._ext))return this.log("File extension not permitted"),this._errorMsg("ext"),!1;if(null!==this._size&&!1!==this._settings.maxSize&&this._size/1024>this._settings.maxSize)return this.log("file exceeds "+this._settings.maxSize+"K limit"),this._errorMsg("size"),!1;this.log("pre-upload file check is successful");return!0},_checkExtension:function(a){var b=this._settings.allowedExtensions,
c=b.length;for(a=a.toLowerCase();c--;)if(b[c].toLowerCase()==a)return!0;return!1},submit:function(){this._disabled||this._activeUploads>=this._settings.maxUploads||(this._file=this._queue[0],this._XhrIsSupported&&this._settings.multiple?(this._filename=null!==this._queue[0].fileName&&void 0!==this._queue[0].fileName?this._queue[0].fileName:this._queue[0].name,this._filename=ss.getFilename(this._filename)):this._filename=ss.getFilename(this._queue[0].value),this._ext=ss.getExt(this._filename),this._XhrIsSupported&&
(this._size=this._queue[0].size),this._checkFile()?!1!==this._settings.onSubmit.call(this,this._filename,this._ext)&&(this._activeUploads++,!1===this._settings.multiple&&this.disable(),this._XhrIsSupported?this._uploadXhr():(!1!==this._settings.progressUrl&&null!==this._uploadProgressKey?this._doProgressUpdates=!0:(this._doProgressUpdates=!1,this.log("no upload progress - progressUrl not defined or progress key not available")),this._uploadIframe())):this.removeCurrent())}};