...
"0"!==b.style.opacity&&(b.style.filter="alpha(opacity=0)");d.addEvent(this._input,"change",function(){var b=a._overBtn,f,g;if(a._input&&""!==a._input.value){if(t){f=d.getFilename(a._input.files[0].name);g=d.getExt(f);if(!1===a._opts.onChange.call(a,f,g,b))return;f=a._input.files.length;a._opts.multiple||(f=1);for(g=0;g<f;g++)a._queue.push({file:a._input.files[g],btn:b})}else{f=d.getFilename(a._input.value);g=d.getExt(f);if(!1===a._opts.onChange.call(a,f,g,b))return;a._queue.push({file:a._input,btn:b})}d.removeClass(a._overBtn,
...
"none";b.id=a;return b},_getForm:function(a){var b=d.toElement('<form method="post" enctype="multipart/form-data"></form>');m.body.appendChild(b);b.style.display="none";b.action=this._opts.url;b.target=a.name;return b},_getHidden:function(a,b){var c=m.createElement("input");c.type="hidden";c.name=a;c.value=b;return c},_last:function(a,b,c,f,g){a&&(a.innerHTML="");b&&d.remove(b);c&&(c.innerHTML="");f&&g&&d.remove(f);this._active--;this._disabled&&this.enable();this._cycleQueue()},_errorFinish:function(a,
b,c,d,g,e,k,s,p,q){this.log("Upload failed: "+a+" "+b);this._opts.onError.call(this,d,c,a,b,q);this._last(g,e,k,s,p)},_finish:function(a,b,c,f,g,e,k,s,p,q){this.log("Server response: "+c);if("json"==this._opts.responseType.toLowerCase()&&(c=d.parseJSON(c),!1===c)){this._errorFinish(a,b,"parseerror",f,g,e,s,p,q);return}this._opts.onComplete.call(this,f,c,q);this._last(g,e,k,s,p)},_uploadXhr:function(a,b,c,f,g,e,k,s,p){var q=this,h=this._opts,n=d.newXHR(),l={},r,m;l[h.name]=a;d.extendObj(l,h.data);
l=h.url+"?"+d.obj2string(l);c&&(c.innerHTML=b+"K");e&&(e.innerHTML="0%");f&&(f.style.width="0%");h.onProgress.call(this,0);r=function(d,f){var l,m;try{if(r&&(f||4===n.readyState))if(n.onreadystatechange=function(){},r=u,f)4!==n.readyState&&n.abort(),q._last(c,g,e,k,s),h.onAbort.call(q,a,p);else{l=n.status;try{m=n.statusText}catch(v){m=""}200<=l&&300>l?(h.endXHR.call(q,a,b,p),q._finish(l,m,n.responseText,a,c,g,e,k,s,p)):q._errorFinish(l,m,"error",a,c,g,e,k,s,p)}}catch(t){f||q._errorFinish(-1,t.message,
"error",a,c,g,e,k,s,p)}};m=function(){d.removeEvent(k,"click",m);r&&r(u,!0)};k&&d.addEvent(k,"click",m);n.onreadystatechange=r;n.open(h.method.toUpperCase(),l,!0);d.addEvent(n.upload,"progress",function(a){a.lengthComputable&&(a=Math.round(a.loaded/a.total*100),h.onProgress.call(q,a),e&&(e.innerHTML=a+"%"),f&&(f.style.width=a+"%"))});n.setRequestHeader("X-Requested-With","XMLHttpRequest");n.setRequestHeader("X-File-Name",encodeURIComponent(a));"json"==h.responseType.toLowerCase()&&n.setRequestHeader("Accept",
"application/json, text/javascript, */*; q=0.01");if(!0===h.multipart){var l=new FormData,v;for(v in h.data)h.data.hasOwnProperty(v)&&l.append(v,h.data[v]);l.append(h.name,this._file);this.log("Commencing upload using multipart form");n.send(l)}else n.setRequestHeader("Content-Type","application/octet-stream"),this.log("Commencing upload using binary stream"),n.send(this._file);this.removeCurrent()},_uploadIframe:function(a,b,c,f,g,e){var k=this,s=this._opts,p=this._progKey,q=this._getFrame(),h=this._getForm(q),
...
p);s.endNonXHR.call(k,a,e);k._finish("","",c,a,b,f,g,u,u,e)}catch(h){k._errorFinish("",h.message,"error",a,b,f,g,u,u,e)}k._sizeFlags&&k._sizeFlags[p]&&delete k._sizeFlags.key;n();d.remove(q);s=p=q=b=f=g=e=null});k.log("Commencing upload using iframe");h.submit();d.remove(h);h=l=null;if(this._opts.progressUrl||this._opts.nginxProgressUrl)this._progKeys.push(p),r.setTimeout(function(){k._getProg(p,c,b,g,1);c=b=g=null},k._opts.checkProgressInterval),this._progKey=d.getUID();this.removeCurrent()},_getProg:function(a,
b,c,f,g){var e=this,k=d.newXHR(),m=(new Date).getTime(),p,q;a&&(this._opts.nginxProgressUrl?p=e._opts.nginxProgressUrl+"?_="+m:this._opts.progressUrl&&(p=e._opts.progressUrl+"?progresskey="+encodeURIComponent(a)+"&_="+m),q=function(){var h,n,l,m,p;try{if(q&&4===k.readyState){k.onreadystatechange=function(){};q=u;m=k.status;try{p=k.statusText}catch(s){p=""}if(200<=m&&300>m){h=d.parseJSON(k.responseText);g++;if(!1===h){e.log("Error parsing progress response (expecting JSON)");return}if(e._opts.nginxProgressUrl)if("uploading"==
h.state)n=h.size,0<n&&(l=Math.round(h.received/n*100),n=Math.round(n/1024));else if("done"==h.state)l=100;else{if("error"==h.state){e.log("Error requesting upload progress: "+h.status);return}}else e._opts.progressUrl&&!0===h.success&&(n=h.size,l=h.pct);l&&(f&&(f.innerHTML=l+"%"),b&&(b.style.width=l+"%"),e._opts.onProgress.call(e,l));n&&!e._sizeFlags[a]&&(e._sizeFlags[a]=1,c&&(c.innerHTML=n+"K"),e._opts.onUpdateFileSize.call(e,n));if(!l&&!n&&g>=e._maxFails){e.log("Failed progress request limit reached");
return}100>l&&d.contains(e._progKeys,a)&&r.setTimeout(function(){e._getProg(a,b,c,f,g);a=b=c=f=g=null},e._opts.checkProgressInterval)}else d.removeItem(e._progKeys,a),e.log("Error requesting upload progress: "+m+" "+p);k=n=l=m=p=h=null}}catch(t){e.log("Error requesting upload progress: "+t.message)}},k.onreadystatechange=q,k.open("GET",p,!0),e._opts.nginxProgressUrl&&k.setRequestHeader(e._opts.nginxProgressHeader,a),k.setRequestHeader("X-Requested-With","XMLHttpRequest"),k.setRequestHeader("Accept",
"application/json, text/javascript, */*; q=0.01"),k.send())},_checkFile:function(a,b,c){var d=this._opts.allowedExtensions,g=d.length,e=!1;if(0<g){for(b=b.toLowerCase();g--;)if(d[g].toLowerCase()==b){e=!0;break}if(!e)return this.removeCurrent(),this.log("File extension not permitted"),this._opts.onExtError.call(this,a,b),!1}return c&&!1!==this._opts.maxSize&&c>this._opts.maxSize?(this.removeCurrent(),this.log(a+" exceeds "+this._opts.maxSize+"K limit"),this._opts.onSizeError.call(this,a,c),!1):!0},
submit:function(){var a,b,c;if(!(this._disabled||this._active>=this._opts.maxUploads||1>this._queue.length)&&(this._file=this._queue[0].file,t?(a=d.getFilename(this._file.name),c=Math.round(this._file.size/1024)):a=d.getFilename(this._file.value),b=d.getExt(a),this._checkFile(a,b,c)&&!1!==this._opts.onSubmit.call(this,a,b,this._queue[0].btn))){this._active++;(!1===this._opts.multiple||!1===this._opts.queue&&this._active>=this._opts.maxUploads)&&this.disable();if(t){if(!1===this._opts.startXHR.call(this,
a,c,this._queue[0].btn)){this._disabled&&this.enable();this._active--;return}this._uploadXhr(a,c,this._sizeBox,this._progBar,this._progBox,this._pctBox,this._abortBtn,this._removeAbort,this._queue[0].btn)}else{if(!1===this._opts.startNonXHR.call(this,a,this._queue[0].btn)){this._disabled&&this.enable();this._active--;return}this._uploadIframe(a,this._sizeBox,this._progBar,this._progBox,this._pctBox,this._queue[0].btn)}this._sizeBox=this._progBar=this._progBox=this._pctBox=this._abortBtn=this._removeAbort=
null}}};r.ss=d})(window,document);