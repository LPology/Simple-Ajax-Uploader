...
a.name);return b},_createHiddenInput:function(a,b){var c=document.createElement("input");c.setAttribute("type","hidden");c.setAttribute("name",a);c.setAttribute("value",b);return c},_finish:function(a,b,c,e,d){this.log("server response: "+a);this._activeUploads--;"json"==this._settings.responseType.toLowerCase()&&(a=ss.parseJSON(a));!1===a?(this.log("bad server response"),this._settings.onError.call(this,b,"parseerror",a)):this._settings.onComplete.call(this,b,a);d&&ss.remove(d);this._disabled&&this.enable();
this._cycleQueue()},_cycleQueue:function(){this._progressContainer=this._progressBar=this._fileSizeBox=this._ext=this._filename=this._file=this._size=null;0<this._queue.length&&this.submit()},_uploadXhr:function(){var a=this,b=a._settings,c=a._filename,e=Math.round(a._size/1024),d=a._fileSizeBox,h=a._progressBar,j=a._progressContainer,g=ss.newXHR(),f={};!1===b.startXHR.call(a,c,e)?(a._disabled&&a.enable(),this._activeUploads--):(d&&(d.innerHTML=e+"K"),b.onProgress.call(a,0),h&&(h.style.width="0%"),
f[b.name]=c,ss.extendObj(f,b.data),f=b.url+"?"+ss.obj2string(f),ss.addEvent(g.upload,"progress",function(c){c.lengthComputable&&(c=Math.round(100*(c.loaded/c.total)),b.onProgress.call(a,c),h&&(h.style.width=c+"%"))}),ss.addEvent(g.upload,"error",function(){a.log("transfer error during upload");b.endXHR.call(a,c,e);b.onError.call(a,c,"transfer error","none")}),g.onreadystatechange=function(){4===this.readyState&&(200===this.status?(b.endXHR.call(a,c,e),a._finish(this.responseText,c,h,d,j)):(a.log("Progress key error. Status: "+
this.status+" Response: "+this.responseText),b.onError.call(a,c,"server error",this.responseText)))},g.open("POST",f,!0),g.setRequestHeader("X-Requested-With","XMLHttpRequest"),g.setRequestHeader("X-File-Name",encodeURIComponent(c)),"json"==b.responseType.toLowerCase()&&g.setRequestHeader("Accept","application/json, text/javascript, */*; q=0.01"),!0===b.multipart?(f=new FormData,f.append(b.name,a._file),a.log("commencing upload using multipart form"),g.send(f)):(g.setRequestHeader("Content-Type",
"application/octet-stream"),a.log("commencing upload using binary stream"),g.send(a._file)),a.removeCurrent())},_handleIframeResponse:function(a,b,c,e,d){var h;a.parentNode&&(h=a.contentWindow?a.contentWindow.document:a.contentDocument&&a.contentDocument.document?a.contentDocument.document:a.contentDocument,h.body&&!1===h.body.innerHTML||(h=h.body.innerHTML,ss.remove(a),this._finish(h,b,c,e,d)))},_uploadIframe:function(){var a=this,b=a._settings,c=b.checkProgressInterval,e=a._uploadProgressKey,d=
