...
"="+h);!1!==k.progressUrl&&(q=this._getHidden(k.keyParamName,h),l.appendChild(q),q=null);for(var r in k.data)k.data.hasOwnProperty(r)&&(q=this._getHidden(r,k.data[r]),l.appendChild(q));l.appendChild(this._file);m&&(m.innerHTML="0%");k.onProgress.call(this,0);d&&(d.style.width="0%");c.addEvent(g,"load",function(){try{var d=(g.contentDocument?g.contentDocument:g.contentWindow.document).body.innerHTML;c.removeEvent(g,"load",arguments.callee);c.remove(g);c.removeItem(e._progKeys,h);k.endNonXHR.call(e,
