...
this._settings.responseType.toLowerCase()&&(a=c.parseJSON(a),!1===a)){this._errorFinish("parseerror","Bad server response",b,g,d,e,f);return}this._activeUploads--;this.log("server response: "+g);e&&(e.innerHTML="");f&&c.remove(f);this._settings.onComplete.call(this,b,a);this._cycleQueue()},_cycleQueue:function(){this._progressContainer=this._progressBar=this._fileSizeBox=this._ext=this._filename=this._file=this._size=null;this._disabled&&this.enable();0<this._queue.length&&this._settings.autoSubmit&&
this.submit()},_uploadXhr:function(a){var b=this,d=this._settings,e=this._filename,f=this._size,g=this._fileSizeBox,l=this._progressBar,m=this._progressContainer;a=c.newXHR();var h={};!1===d.startXHR.call(this,e,f)?(this._disabled&&this.enable(),this._activeUploads--):(g&&(g.innerHTML=f+"K"),h[d.name]=e,c.extendObj(h,d.data),h=d.url+"?"+c.obj2string(h),d.onProgress.call(this,0),l&&(l.style.width="0%"),c.addEvent(a.upload,"progress",function(a){a.lengthComputable&&(a=Math.round(100*(a.loaded/a.total)),
d.onProgress.call(b,a),l&&(l.style.width=a+"%"))}),c.addEvent(a.upload,"error",function(){b._errorFinish("transfererror","Transfer error during upload",e,"None",l,g,m)}),a.onreadystatechange=function(){4===this.readyState&&(200===this.status?(d.endXHR.call(b,e,f),b._finish(this.responseText,e,l,g,m)):b._errorFinish("servererror","Server error. Status: "+this.status,e,this.responseText,l,g,m))},a.open(d.method.toUpperCase(),h,!0),a.setRequestHeader("X-Requested-With","XMLHttpRequest"),a.setRequestHeader("X-File-Name",
encodeURIComponent(e)),"json"==d.responseType.toLowerCase()&&a.setRequestHeader("Accept","application/json, text/javascript, */*; q=0.01"),!0===d.multipart?(h=new FormData,h.append(d.name,this._file),this.log("commencing upload using multipart form"),a.send(h)):(a.setRequestHeader("Content-Type","application/octet-stream"),this.log("commencing upload using binary stream"),a.send(this._file)),this.removeCurrent())},_handleIframeResponse:function(a,b,d,e,f){var g;a.parentNode&&(g=a.contentWindow?a.contentWindow.document:
a.contentDocument&&a.contentDocument.document?a.contentDocument.document:a.contentDocument,g.body&&!1===g.body.innerHTML||(g=g.body.innerHTML,c.remove(a),this._finish(g,b,d,e,f)))},_uploadIframe:function(){var a=this,b=this._settings,d=b.checkProgressInterval,e=this._uploadProgressKey,f=this._progressBar,g=this._progressContainer,l=this._fileSizeBox,k=this._filename,h=this._createIframe(),n=this._createForm(h),p;this._doProgressUpdates&&(p=this._createHiddenInput(b.keyParamName,e),n.appendChild(p));
if(!1===b.startNonXHR.call(this,k))this._disabled&&this.enable(),this._activeUploads--;else{p=b.data;for(var r in p)if(p.hasOwnProperty(r)){var q=this._createHiddenInput(r,p[r]);n.appendChild(q)}n.appendChild(this._file);b.onProgress.call(this,0);f&&(f.style.width="0%");c.addEvent(h,"load",function(){c.contains(a._activeProgressKeys,e)&&c.removeItem(a._activeProgressKeys,e);c.removeEvent(h,"load",arguments.callee);b.endNonXHR.call(a,k);a._handleIframeResponse(h,k,f,l,g);e=null});a.log("commencing upload using iframe");
n.submit();c.remove(n);n=null;a._doProgressUpdates&&(this._activeProgressKeys.push(e),m.setTimeout(function(){a.log("requesting first progress update");a._getUploadProgress(e,f,l,1)},d),this._alterProgressKey());this.removeCurrent()}},_getUploadProgress:function(a,b,d,e){if(a){var f=this,g=this._settings,l=c.newXHR(),k=(new Date).getTime(),k=g.progressUrl+"?progresskey="+encodeURIComponent(a)+"&_="+k;l.onreadystatechange=function(){var h,k=g.checkProgressInterval;if(4===this.readyState)if(200===this.status){if((h=
c.parseJSON(this.responseText))&&!0===h.success){e++;g.onUpdateFileSize.call(f,h.size);g.onProgress.call(f,h.pct);b&&(b.style.width=h.pct+"%");d&&h.size&&(d.innerHTML=h.size+"K");if(100>h.pct&&c.contains(f._activeProgressKeys,a)){if(0===h.pct&&0===h.size&&e>=f._maxUpdateFails){f.log("reached limit of failed progress requests");return}m.setTimeout(function(){f._getUploadProgress(a,b,d,e);e=a=null},k)}k=null}}else a=null,f._doProgressUpdates=!1,f._uploadProgressKey=null,c.removeItem(f._activeProgressKeys,
a),f.log("Progress error. Status: "+this.status+" Response: "+this.responseText);h=null};l.open("GET",k,!0);l.setRequestHeader("X-Requested-With","XMLHttpRequest");l.setRequestHeader("Accept","application/json, text/javascript, */*; q=0.01");l.setRequestHeader("Cache-Control","no-cache");l.send();l=null}},_alterProgressKey:function(){this._uploadProgressKey+=c.getUID();57<this._uploadProgressKey.length&&(this._uploadProgressKey=c.getUID()+this._uploadProgressKey.substring(0,15))},_getUploadProgressKey:function(){var a=
...
!1,this.log("no upload progress - progressUrl not defined or progress key not available")),this._uploadIframe())))}};m.ss=c})(window,document);